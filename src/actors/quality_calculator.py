...
from src.quality_functions import deletion_overhead_quality_function, marginals_distance_quality_function, \
    machine_learning_accuracy_quality_function, violations_count_quality_function


def calculate_quality(task: Task, quality_function: QualityFunctions,
